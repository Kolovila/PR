...
SWEP.WorldModel					= "models/misha_eft/guns_wip/w_smg_mp5.mdl"
SWEP.HoldType 					= "ar2"
	-- World Model ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound				= {"mishaeft_guns/mp5_fire1.wav"}
SWEP.Primary.DistantSound		= {"mishaeft_guns/mp5_dist1.wav"}
