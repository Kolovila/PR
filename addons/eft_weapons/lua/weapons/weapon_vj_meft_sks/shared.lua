...
SWEP.WorldModel					= "models/misha_eft/guns_wip/w_rif_sks.mdl"
SWEP.HoldType 					= "smg"
	-- World Model ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound				= {"mishaeft_guns/sks_fire_close.wav"}
SWEP.Primary.DistantSound		= {"mishaeft_guns/sks_fire_distant.wav"}
