...
SWEP.WorldModel					= "models/misha_eft/guns_wip/w_smg_ump.mdl"
SWEP.HoldType 					= "smg"
	-- World Model ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound				= {"mishaeft_guns/ump_fire1.wav"}
SWEP.Primary.DistantSound		= {"mishaeft_guns/ump_dist1.wav"}
