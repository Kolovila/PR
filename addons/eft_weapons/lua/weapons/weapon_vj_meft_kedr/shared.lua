...
SWEP.WorldModel					= "models/misha_eft/guns_wip/w_smg_pp91.mdl"
...
SWEP.Primary.Sound				= {"mishaeft_guns/kedr_close.wav"}
SWEP.Primary.DistantSound		= {"mishaeft_guns/kedr_dist.wav"}
