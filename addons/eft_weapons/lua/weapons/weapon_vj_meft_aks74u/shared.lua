...
SWEP.WorldModel					= "models/misha_eft/guns_wip/w_rif_ak74u_var1.mdl"
SWEP.HoldType 					= "ar2"
	-- World Model ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound				= {"mishaeft_guns/aksu_close.wav"}
SWEP.Primary.DistantSound		= {"mishaeft_guns/aksu_dist.wav"}
