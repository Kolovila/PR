...
SWEP.WorldModel					= "models/misha_eft/guns_wip/w_rif_var1_m4a1.mdl"
SWEP.HoldType 					= "ar2"
	-- World Model ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound				= {"mishaeft_guns/m4a1_fire1.wav"}
SWEP.Primary.DistantSound		= {"mishaeft_guns/m4a1_dist1.wav"}
