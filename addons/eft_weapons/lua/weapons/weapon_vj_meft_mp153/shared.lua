...
SWEP.NPC_FiringDistanceScale = 0.5 -- Changes how far the NPC can fire | 1 = No change, x < 1 = closer, x > 1 = farther
	-- Main Settings ---------------------------------------------------------------------------------------------------------------------------------------------
SWEP.WorldModel = "models/misha_eft/guns_wip/w_shot_mp155.mdl"
SWEP.HoldType = "ar2"
...
SWEP.Primary.Sound = {"mishaeft_guns/mr153_fire_close1.wav", "mishaeft_guns/mr153_fire_close2.wav"}
SWEP.Primary.DistantSound = {"mishaeft_guns/mr153_fire_distant1.wav", "mishaeft_guns/mr153_fire_distant2.wav"}
