...
SWEP.WorldModel					= "models/misha_eft/guns_wip/w_rif_scar.mdl"
SWEP.HoldType 					= "smg"
	-- World Model ---------------------------------------------------------------------------------------------------------------------------------------------
...
SWEP.Primary.Sound				= {"mishaeft_guns/scar_fire1.wav"}
SWEP.Primary.DistantSound		= {"mishaeft_guns/scar_fire1.wav"}
